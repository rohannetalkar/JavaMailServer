...
{ 
   ...
   if ( ( StudentRegistration.Class[0].checked == false ) && ( StudentRegistration.Class[1].checked == false ) )
   {
   ...
   {
     alert( "Please provide Source Airport!" );
   ...
   {
     alert( "Please provide your Select Destination Airport!" );
    
     return false;
   }   
   if( document.StudentRegistration.State.value == "-1" )
   {
     alert( "Please provide your Airline!" );
